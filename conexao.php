...
$telefone_sistema = '(84) 99953-3663';
...
if(@count($res) == 0){
	...
	$pdo->query("INSERT INTO config SET nome_sistema = '$nome_sistema', telefone_sistema = '$telefone_sistema', email_sistema = '$email_sistema', logo = 'logo.png', icone = 'favicon.ico', logo_rel = 'logo.jpg' ");
}else{
